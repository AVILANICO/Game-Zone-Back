export let companies = [{
    ...
    logo: "https://fotografias-neox.atresmedia.com/clipping/cmsimages01/2017/10/03/A530B418-FFBC-4C1D-B221-D00281EF97BF/98.jpg?crop=1280,720,x0,y0&width=1900&height=1069&optimize=high&format=webply",
    website: "https://sonyinteractive.com/en/",
    description: "Sony Interactive Entertainment (SIE) es una subsidiaria de Sony Corporation y una de las compañías líderes en la industria de los videojuegos. Fundada en 1993, SIE se dedica al desarrollo, publicación y distribución de software y hardware de entretenimiento interactivo.",
    active: true,
    user_id: "sony@team.com.ar"
},{
    name: "Electronic Arts (EA)",
    logo: "https://e7.pngegg.com/pngimages/112/223/png-clipart-fifa-13-ea-sports-logo-electronic-arts-sports-game-ea-sports-text-trademark.png",
    website: "https://www.ea.com/es-es",
    description: "is a renowned United States-based interactive entertainment company. Founded in 1982, it has become one of the most important companies in the video game industry worldwide.",
    active: true,
    user_id: "electronic@team.com.ar"
},{
    name: "Blizzard Entertainment",
    logo: "https://upload.wikimedia.org/wikipedia/commons/thumb/b/b2/Blizzard_Entertainment_Logo.svg/2560px-Blizzard_Entertainment_Logo.svg.png",
    website: "https://www.blizzard.com/es-es/",
    description: "a renowned video game company based in Irvine, California, United States. Blizzard Entertainment is known for developing and publishing several popular titles in the video game industry, including Warcraft, Diablo, StarCraft, and Hearthstone.",
    active: true,
    user_id: "blizzard@team.com.ar"
},{
    name: "Valve Corporation",
    logo: "https://download.logo.wine/logo/Valve_Corporation/Valve_Corporation-Logo.wine.png",
    website: "https://www.valvesoftware.com/es/",
    description: "is a video game and software company headquartered in Bellevue, Washington, United States. It was founded in 1996 by Gabe Newell and Mike Harrington, two former Microsoft employees. Valve is known for creating and publishing some of the most influential video games in the industry, as well as developing the digital distribution platform Steam, which has become one of the most popular and successful in the world.",
    active: true,
    user_id: "valve@team.com.ar"
},{
    name: "Epic Games",
    ...
    description: "is a video game development company based in Cary, North Carolina. She is recognized for her game Fortnite. Fortnite is an online battle royale game that has gained immense popularity since its release in 2017. Players are dropped on an island where they fight other players in a massive battle arena until only one player or team is left standing. In addition to the battle royale mode, Fortnite also offers creative and cooperative game modes. He is known for his colorful visual style, its structure building system and its continuous content update to keep the game fresh and exciting.",
    active: true,
    user_id: "epicgames@team.com.ar"
},{
    name: "Peace",
