export let games = [
    {
        ...
        cover_photo: 'https://e00-marca.uecdn.es/assets/multimedia/imagenes/2019/03/27/15537190644260.png',
        description: 'Is a popular first-person shooter (FPS) game developed by Valve Corporation. It is the fourth main installment in the Counter-Strike series and has become one of the most influential and competitive eSports games. In CS:GO, players are divided into two teams: terrorists and counter-terrorists. The objective varies depending on the game mode, but generally it involves planting or defusing bombs, rescuing or protecting hostages, or eliminating all members of the opposing team.',
        category_id: 'shooter',
        author_id: 'Nicolas',
        ...
        cover_photo: 'https://www.xtrafondos.com/descargar.php?id=4006&resolucion=3840x2160',
        description: 'Is a first-person shooter video game developed by Infinity Ward and published by Activision. It is part of the popular Call of Duty game series and was released in 2019. The game is set in a contemporary world and features a Intense and realistic story focused on modern combat and special operations. Players assume the role of soldiers of elite and immersed in an exciting campaign that tackles topics such as terrorism, chemical warfare and geopolitical tensions.',
        category_id: 'shooter',
        author_id: 'Nicolas',
        ...
        description: 'Is a first-person shooter game developed and published by Blizzard Entertainment. It is an online team game that was released in 2016 and has gained huge popularity ever since. In Overwatch, players form teams of six and take on specific roles, each with unique abilities and distinct playstyles. Players can choose from a wide variety of heroes, which are divided into categories such as tanks, damage, support, and defense. Each hero has special abilities and a specific role on the team, encouraging cooperation and strategy.',
        category_id: 'shooter',
        author_id: 'Nicolas',
        ...
        title: 'Battlefield V',
        cover_photo: 'https://media.contentapi.ea.com/content/dam/bf/images/2020/10/bfv-web-1920x1080-definitiveedition.jpg.adapt.crop16x9.575p.jpg',
        description: 'Is a first-person shooter game developed by DICE and published by Electronic Arts. Set in World War II, the game offers an epic and cinematic combat experience with a focus on multiplayer. In Battlefield V, players are immersed in a variety of war theaters around the world, from war-torn cities to vast open fields. The game features a mix of land, air, and water combat, allowing players to engage in massive and chaotic battles.',
        category_id: 'shooter',
        author_id: 'Nicolas',
        ...
        description: "is a highly popular multiplayer online battle arena (MOBA) game developed and published by Riot Games. It is played by millions of players worldwide and has become a prominent esports phenomenon. In the game, two teams, each consisting of five players, compete against each other on a virtual battlefield known as the Summoner's Rift.",
        category_id: 'multiplayer',
        author_id: 'Laureano',
        ...
        description: 'is an online multiplayer game that combines elements of battle royale, building, and exploration in a vibrant and ever-changing world. Developed by Epic Games, it has become a global phenomenon, captivating players of all ages with its unique gameplay and constant updates.',
        category_id: 'multiplayer',
        author_id: 'Laureano',
        company_id: 'Epic Games',
        price: '20',
        ...
        cover_photo: 'https://3.bp.blogspot.com/-89PEr3LtbHc/UZCgqr7bJDI/AAAAAAAAASY/QSthSw6Ig7c/s1600/need+for+speed+world+free+download+for+pc+full+version.jpg',
        description: 'In "Need for Speed: World," players were given the freedom to explore a vast virtual environment and engage in a variety of game modes, including circuit racing, speed racing, and police chases. The game offered a wide selection of cars of different makes and models, which could be customized and upgraded to improve racing performance. Players could also join clans and team up with other players to compete together and take on more difficult challenges. As they progressed through the game, players unlocked new customization options, cars, and challenges.',
        category_id: 'race',
        author_id: 'Francisco',
        company_id: 'Electronic Arts (EA)',
        price: '20',
        ...
        cover_photo: 'https://i.ytimg.com/vi/qxOyIAeLyGQ/maxresdefault.jpg',
        description: 'The game was based on the 2007 Formula 1 season and featured all of the official teams and drivers from that season. Players were given the opportunity to race on the actual circuits found on the Formula 1 calendar, accurately recreated. "F1 Championship Season 2007" offered a full career mode, where players could assume the role of a driver and work their way to the championship, competing in various races and fulfilling different objectives. The game also featured car tuning and customization options to optimize performance on the track.',
        category_id: 'race',
        author_id: 'Francisco',
        company_id: 'Electronic Arts (EA)',
        price: '20',
        ...
        cover_photo: 'http://images.gamersyde.com/gallery/public/25135/2933_0014.jpg',
        description: 'The game focuses on providing a realistic high-performance racing experience in a wide variety of motoring disciplines. "GRID Autosport" offers an extensive selection of cars from different categories, such as passenger cars, single-seaters, GTs and more. Players can compete in different game modes, including single races, championships, challenges, and night races. A prominent feature of "GRID Autosport" is its focus on realism and authenticity. The game features compelling driving physics, detailed graphics, and dynamic weather effects that affect the cars performance and driving experience. Additionally, players can customize and tune their vehicles to suit different tracks and driving styles.',
        category_id: 'race',
        author_id: 'Francisco',
        ...
        cover_photo: 'https://theinformant.co.nz/wp-content/uploads/2021/02/Assetto-Corsa-Competizione-The-British-GT-Pack-is-now-1536x864.jpg',
        description: 'This content pack adds a selection of new cars and tracks from the British GT Championship. Players will be able to compete in exciting races with GT cars from renowned brands such as Aston Martin, Bentley and McLaren, among others. These vehicles have been accurately recreated, both in terms of visual appearance and behavior on the track. Additionally, the DLC includes iconic British circuits that are part of the British GT Championship. Players will be able to enjoy detailed and realistic tracks, facing the challenges and characteristic curves of each circuit. With the "Assetto Corsa Competizione: British GT Pack", players will be able to immerse themselves in the exciting world of GT racing in the UK, competing against other drivers and experiencing the intensity and competition of the British GT Championship.',
        category_id: 'race',
        author_id: 'Francisco',
        ...
        title: 'NBA 2K23',
        cover_photo: 'https://assets.xboxservices.com/assets/dd/64/dd649e2a-7e7a-4abb-ad50-0ab2c042a3fe.jpg?n=994894_GLP-Page-Hero-1084_1920x1080.jpg',
        description: 'Experience basketball like never before with the NBA video game! Immerse yourself on the court and enjoy the emotion and intensity of the most famous basketball league in the world. With stunning graphics and realistic players, you will experience the authenticity of professional basketball. Master the moves and skills of your favorite players as you compete in exciting matches or challenge other players in online multiplayer. Enjoy the action, spectacular dunks and tactical strategy in the NBA video game!',
        category_id: 'sport',
        author_id: 'Diego',
        company_id: 'Electronic Arts (EA)',
        price: '20',
        ...
        title: 'FIFA 23',
        cover_photo: 'https://a2.espncdn.com/combiner/i?img=%2Fphoto%2F2022%2F0721%2Fr1038949_2_1080x608_16%2D9.jpg',
        description: 'is an acclaimed soccer video game that offers a realistic and exciting experience. With official licenses from real leagues, teams and players, you will immerse yourself in a virtual world where you can play matches, compete in tournaments and manage your own team. Enjoy stunning graphics, smooth gameplay, and online game modes to take on players from all over the world. Live the passion of soccer on your own screen with FIFA!',
        category_id: 'sport',
        author_id: 'Diego',
        company_id: 'Electronic Arts (EA)',
        price: '20',
        ...
        title: 'Madden NFL',
        cover_photo: 'https://media.contentapi.ea.com/content/dam/ea/madden-nfl/madden-nfl-23/launch/images/2022/06/eas-madden23-gen5-ame-crop-1920x1080.jpg.adapt.crop191x100.1200w.jpg',
        description: "is the most popular and authentic American football video game. Immerse yourself in the excitement of the NFL with strategic gameplay, updated teams, and exciting game modes. With stunning graphics and realistic details, you'll feel like a real football player or coach. Challenge your friends in online multiplayer matches and experience the intensity of the competition. Experience the greatness of the NFL on your own console with Madden NFL!",
        category_id: 'sport',
        author_id: 'Diego',
        company_id: 'Electronic Arts (EA)',
        price: '20',
        ...
        title: 'Raft',
        cover_photo: 'https://cdn.cloudflare.steamstatic.com/steam/apps/648800/header.jpg?t=1655744208',
        ...
        description: "Dive into the Octagon with the exciting video game of the UFC. Experience the intensity and excitement of mixed martial arts as you take on the best fighters in the world. With realistic and fluid gameplay, you will be able to pull off impressive moves and execute authentic fighting techniques. Customize your own fighter and rise through the ranks in Career mode, or challenge your friends in exciting online battles. Get ready for adrenaline and unlimited action with the UFC video game!",
        category_id: 'sport',
        author_id: 'Diego',
        company_id: 'Electronic Arts (EA)',
        price: '20',
